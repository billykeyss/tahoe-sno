...
// Modern SaaS theme with enhanced design system
      ...
      <Box
        sx={{
          ...
          backgroundImage: isDarkMode
            ? 'radial-gradient(ellipse at top, rgba(37, 99, 235, 0.05) 0%, transparent 70%), radial-gradient(ellipse at bottom, rgba(124, 58, 237, 0.05) 0%, transparent 70%)'
            : 'radial-gradient(ellipse at top, rgba(37, 99, 235, 0.03) 0%, transparent 70%), radial-gradient(ellipse at bottom, rgba(124, 58, 237, 0.03) 0%, transparent 70%)',
          display: 'flex',
          ...
          <Container maxWidth="xl">
            ...
            >
              ...
              <Stack direction="row" spacing={1} alignItems="center">
                <Tooltip title="British Columbia Resorts" arrow>
                  <IconButton
                    component={Link}
                    to="/bc"
                    sx={{
          ...
          <Container maxWidth="lg">
            ...
            >
              ...
              >
                ...
                conditions for all Lake Tahoe ski resorts. Updated hourly with
                the latest data.
              </Typography>
              ...
              <Box sx={{ mt: 4 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                  <Chip
                    ...
                    label="British Columbia & Calgary Resorts"
                    clickable
                    sx={{
        ...
        >
          <Container maxWidth="xl">
            ...
            >
              ...
              >
                © 2024 TahoeSno • Weather data provided by Open-Meteo API
              </Typography>
            </Box>
          </Container>
        </Paper>
